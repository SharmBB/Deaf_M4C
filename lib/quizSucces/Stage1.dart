...
class Stage1 extends StatefulWidget {
   Stage1({Key? key, required this.persentage,required this.max,required this.correct}) : super(key: key);
...
class _HomePageState extends State<Stage1> {
        ...
        appBar: AppBar(
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => LockPage(nilai: 1,next_nilai: 2,)),
              );
            },
          ),
          leadingWidth: 70,
