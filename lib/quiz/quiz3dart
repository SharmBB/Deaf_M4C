...
import 'package:deaf_app/quizSucces/Stage3.dart';
...
class Quiz3Page extends StatefulWidget {
  Quiz3Page({Key? key, required this.title}) : super(key: key);
                                                                  ...
                                                                  child:Stack(children: [
                                                                        Container(
                                                                            ...
                                                                            child: Padding(
                                                                                ...
                                                                                child: Text(
                                                                                    quiz[int.parse(_question.toString()) - 1]['Answers'][index_A]
                                                                              [
                                                                              'Answer_Name'],
                                                                                  style: GoogleFonts.muktaMalar(
                                                                                    fontSize: 20,
