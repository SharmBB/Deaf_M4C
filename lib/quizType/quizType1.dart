                              ...
                              GridView.builder(
                                  ...
                                  itemBuilder: (BuildContext ctx, index_A) {
                                    return GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          isAnswer = _foundAnswers[index_A]
                                              ['is_answer'];
                                        });
                                      ...
                                      child: Card(
                                        color: userSelectedAnswer == index_A ? Colors.yellow : null,
                                        elevation: 0,
                                        child: Stack(
                                          children: <Widget>[
                                            Padding(
                                            ...
                                            Visibility(
                                              ...
                                              child: _foundAnswers[index_A]['is_answer'] == 1 ? Icon(Icons.check, color: Colors.green,) : Icon(Icons.clear, color: Colors.red,),
                                              ),
                                            )
